...
__all__ = [ 'Font', 'OLE_YPOS_PIXELS', 'FONTSTRIKETHROUGH',
           'OLE_YSIZE_PIXELS', 'OLE_YSIZE_CONTAINER',
           'OLE_YSIZE_HIMETRIC', 'Gray', 'FONTNAME', 'FONTSIZE',
           'Monochrome', 'FONTBOLD', 'FONTUNDERSCORE',
           'OLE_XSIZE_HIMETRIC', 'LoadPictureConstants',
           'IPictureDisp', 'Checked', 'VgaColor', 'OLE_COLOR',
           'FONTITALIC', 'IFont', 'Color', 'IFontDisp', 'IPicture',
           'OLE_YPOS_HIMETRIC', 'OLE_YPOS_CONTAINER', 'Default',
           'OLE_HANDLE', 'FontEvents', 'OLE_XPOS_CONTAINER',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_CANCELBOOL', 'OLE_TRISTATE',
           'OLE_XSIZE_PIXELS', 'OLE_XSIZE_CONTAINER',
           'IFontEventsDisp', 'OLE_OPTEXCLUSIVE', 'StdPicture',
           'Picture', 'OLE_XPOS_PIXELS', 'StdFont', 'Unchecked',
           'OLE_XPOS_HIMETRIC']
